...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("0437b02c049dafe347609cdff052f01a28aa39ecac50059a6edcf782d518b67e1b47dea445e4682f856722ca871e9b1a61b40e89ba983ac3d517eefab81b12aed3");
        nDefaultPort = 15824;
        nRPCPort = 15825;
        ...
        //python genesis.py -a scrypt -z "20 Feb 2014 Bitcoin ATMs come to USA" -p "" -t 1393221600 -n 2084524493



        const char* pszTimestamp = "BBC News 11/01/2015 Millions rally for French unity";
        CTransaction txNew;
        txNew.nTime = 1421017177;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1421017177;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 426244;

        hashGenesisBlock = genesis.GetHash();
        //printf("hashMerkleRoot: %s\n", genesis.hashMerkleRoot.GetHex().c_str());

        assert(genesis.hashMerkleRoot == uint256("0x09a1e42625265e65d4ac9f1897a3b4ac8f47d30f93fe47dbf2efde892b7b6391"));
        if(hashGenesisBlock != uint256("0x00000578d9e2f51e4b739c88af3877898902b2b7a399c6444ea836e2644e4034")) MineGenesis(genesis);
...
public:
    CTestNetParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 302442;
        hashGenesisBlock = genesis.GetHash();
        if(hashGenesisBlock != uint256("0x000006704516fbd8823abacb7a7f1271a31cc550670df1455cddc6ea70ba48ea")) MineGenesis(genesis);
...
public:
    CRegTestParams() {
        ...
        genesis.nTime = 1422222222;
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 1542891;
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 28444;
        strDataDir = "regtest";
        if(hashGenesisBlock != uint256("0x00000dbd6ed7dbf83359f7707d3754b5b33ccfcccb49735d5bdfb18812c9aa19")) MineGenesis(genesis);
