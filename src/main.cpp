...
const string strMessageMagic = "FXCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
    ...
    if(nHeight > 0 && nHeight < 101) nSubsidy = 50000000 * COIN;
...
#ifdef ENABLE_WALLET
// fxcoin: attempt to generate suitable proof-of-stake
